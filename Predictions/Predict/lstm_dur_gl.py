                ...
                if i < curbw:
                    ...
                    if hist[i] > 0:
                        ...
                        while cur <= duration:
                            ...
                            label_data[i].append([(duration - cur)//time_alloc])
                            #if i == 2:
                            #    print("adding: " + str((duration - cur)//time_alloc) + " to: " + str(i))
                            #Every interval
                            cur += rem
                        #inp_data[i].append([duration/time_alloc])
                        #train_bool[i].append(True)
                    ...
                    while hist[i]-max_hist[i] > out_lim:
                        ...
                        label_data[i].append([(hist[i]-max_hist[i])//time_alloc])
                        #if i == 2:
                        #    print("ADding: " + str((hist[i]-max_hist[i])//time_alloc) + " to: " + str(i))
                        #Every five minutes
                        max_hist[i] += rem
                    if max_hist[i] == 0 and hist[i] >= time_alloc:
                        ...
                        while temp_train_val + best_train_val * time_alloc <= hist[i]:
                            ...
                            #if i == 2:
                            #    print("aDding: " + str((best_train_val)//time_alloc) + " to: " + str(i))
                            temp_train_val += rem
    return inp_data
