...
rem = 180
buf = 1
buffers = [1,1/1.05,1/1.1,1/1.2,1/1.3,1/1.4]
if len(sys.argv) >= 3:
...
for i in range(channels):
    ...
    torch.save(checkpoint, str(i)+'_ali_dur.model')
